...
Ext.define('Ext.ux.PinchZoomImage', {
	...
	objDragStart:function(e, el, obj) {
		if (this.getIsObjFrozen()) return;

		this.objPosition.x = parseInt(el.parentElement.style.left+'0');
		this.objPosition.y = parseInt(el.parentElement.style.top+'0');
	...
	objDrag:function(e, el, obj) {
		...
		el.parentElement.style.left = this.objPosition.x+'px';
		el.parentElement.style.top = this.objPosition.y+'px';
